 ...
 * TAD is owner of @filepath and should free it at destroy.
 */
...
/* Creates fat_file instances from the directory entries in @dir's data cluster.
 ...
 * If offset is greater than file size, does not write any data and
 * sets errno to EOVERFLOW (although this is not the expected behaviour of
 * write functions)
 * TODO fill with zeros the gap between file_size and offset.
 * If there is an error in the read or write operations, sets errno to EIO.
 */
